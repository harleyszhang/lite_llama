...
class ModelConfig:
    ...
    def dtype(self) -> torch.dtype:
        ...
        inputs, and a full-fp32 deployment was never possible in rapid_llm.
        """
    ...
    def kv_cache_row(self) -> tuple[int, int]:
        ...
        owns, so :class:`~rapid_llm.executor.model_runner.ModelRunner`
    ...
    def rope_config(self) -> dict[str, Any]:
        """Flat mapping consumed by :mod:`rapid_llm.modules.rotary_embedding`."""
        return {

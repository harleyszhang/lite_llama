...
class ModelRegistry:
    ...
    _SPECS: ClassVar[tuple[ModelSpec, ...]] = (
        ModelSpec("llama", "rapid_llm.models.llama:LlamaModel"),
        ModelSpec("qwen2", "rapid_llm.models.qwen2:Qwen2Model"),
        ModelSpec("qwen3", "rapid_llm.models.qwen3:Qwen3Model"),
        ModelSpec("qwen3_moe", "rapid_llm.models.qwen3_moe:Qwen3MoeModel"),
        ModelSpec("deepseek_v2", "rapid_llm.models.deepseek_v2:DeepseekV2Model"),
        ModelSpec("deepseek_v3", "rapid_llm.models.deepseek_v2:DeepseekV3Model"),
        ModelSpec(
            "deepseek_v4",
            "rapid_llm.models.deepseek_v4:DeepseekV4Model",
            supports_cuda_graph=False,
        ),
        ModelSpec("llava", "rapid_llm.models.llava:LlavaLlama", is_multimodal=True),
        ModelSpec("qwen3_vl", "rapid_llm.models.qwen3_vl:Qwen3VLForCausalLM", is_multimodal=True),
    )

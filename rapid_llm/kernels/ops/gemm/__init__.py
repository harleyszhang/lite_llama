...
Usage:
    from rapid_llm.kernels import linear_torch, linear_w8a16
"""
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="native",
        target="rapid_llm.kernels.ops.gemm.linear:linear_torch",
        schemes=("unquantized",),
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="native",
        target="rapid_llm.kernels.ops.gemm.linear:linear_w8a16",
        dtypes=("bf16", "fp16"),
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="native",
        target="rapid_llm.kernels.ops.gemm.linear:linear_w4a16",
        dtypes=("bf16", "fp16"),
        schemes=("awq", "gptq"),
        golden=NATIVE_BASELINE,
    )
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="native",
        target="rapid_llm.kernels.ops.gemm.linear:linear_w8a8_int8",
        dtypes=("bf16", "fp16"),
        schemes=("w8a8_int8",),
        golden=NATIVE_BASELINE,
    )
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="native",
        target="rapid_llm.kernels.ops.gemm.linear:linear_w8a8_fp8",
        dtypes=("bf16", "fp16"),
        schemes=("w8a8_fp8",),
        golden=NATIVE_BASELINE,
    )
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="native",
        target="rapid_llm.kernels.ops.gemm.linear:linear_nvfp4",
...
register(
    KernelSpec(
        ...
        op="linear",
        backend="deepgemm",
        target="rapid_llm.kernels.backend.deepgemm.linear:fp8_gemm_nt",

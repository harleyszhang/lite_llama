...
checkpoints_dir = "/root/lite_llama/Llama-3.2-1B-Instruct"
...
def main(
    ...
    while True:
        ...
        # 将用户的对话输入历史中
        model_prompter.add_to_history("user",prompt)
        full_prompt =  model_prompter.build_full_prompt(prompt)

        print("\n生成结果: ", end="", flush=True)

        model_prompter.insert_prompt(full_prompt)
